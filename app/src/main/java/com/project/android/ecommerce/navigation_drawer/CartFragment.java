...
import com.project.android.ecommerce.activity.ConfirmFinalOrderActivity;
...
import com.project.android.ecommerce.models.Cart;
import com.project.android.ecommerce.prevalent.Prevalent;
import com.project.android.ecommerce.viewholder.CartViewHolder;
...
public class CartFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        NextProcessBtn = getActivity().findViewById(R.id.next_btn);
        txtTotalAmount = getActivity().findViewById(R.id.total_price);
        txtMsg1 = getActivity().findViewById(R.id.msg1);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (shippingState.equals("shipped")) {
                        ...
                        Toast.makeText(getContext(), "You can purchase more products, once you received your first final order.", Toast.LENGTH_SHORT).show();
